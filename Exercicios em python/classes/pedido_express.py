...
class PedidoExpress(Pedido):
    def __init__(self, id, cliente, data_pedido, itens, taxa_frete_express):
        self.id = id
        self.cliente = cliente
        self.data_pedido = data_pedido
        self.itens = itens
        self.taxa_frete_express = taxa_frete_express
        self.desconto = 0
    ...
    def calcularValorTotal(self):
        ...
        total_com_frete = total + self.taxa_frete_express
